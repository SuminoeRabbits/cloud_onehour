...
class PhpBenchRunner:
    def __init__(self, num_threads=None, quick_mode=False):
        self.benchmark = "phpbench-1.1.6"
        self.benchmark_full = "pts/phpbench-1.1.6"
        self.test_category = "Network" # User specified Category
...
def main():
    ...
    runner = PhpBenchRunner(num_threads=threads, quick_mode=args.quick)
    runner.run()
