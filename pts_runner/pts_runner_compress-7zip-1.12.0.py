...
class Compress7zipRunner:
    ...
    def patch_sha512_build(self):
        ...
        if not patched:
            print("  [WARN] No Makefile was successfully patched")
            return False
    ...
    def generate_summary(self):
        ...
        with open(summary_log, 'w') as f:
            f.write("="*80 + "\n")
            f.write("7-Zip Compression Benchmark Summary\n")
    ...
    def run(self):
        """Main execution flow."""
        print(f"{'='*80}")
        print("7-Zip Compression Benchmark Runner")
        print(f"{'='*80}")
