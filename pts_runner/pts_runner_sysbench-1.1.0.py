...
class SysbenchRunner:
    ...
    def install_benchmark(self):
        ...
        install_cmd = f'CC=gcc-14 CXX=g++-14 CFLAGS="-O3 -march=native -mtune=native" CXXFLAGS="-O3 -march=native -mtune=native" phoronix-test-suite install {self.benchmark_full}'
    ...
    def run_benchmark(self, num_threads):
        ...
        batch_env = f'PTS_USER_PATH_OVERRIDE={user_config_dir} BATCH_MODE=1 SKIP_ALL_PROMPTS=1 TEST_RESULTS_NAME=sysbench-{num_threads}threads TEST_RESULTS_IDENTIFIER=sysbench-{num_threads}threads'
...
Examples:
  ...
  %(prog)s 16        # Run with 16 threads (capped at vCPU if exceeded)
    ...
    # Run benchmark
    runner = SysbenchRunner(args.threads)
    success = runner.run()
