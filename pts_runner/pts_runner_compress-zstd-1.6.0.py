...
- Estimated Install Time: 50 Seconds
- Environment Size: 400 MB
- Test Type: Processor
- Supported Platforms: Linux, BSD, MacOSX, Solaris, Windows

Test Characteristics:
- Multi-threaded: Yes (Zstd compression is highly parallel)
...
class PreSeedDownloader:
    ...
    def download_from_xml(self, benchmark_name, threshold_mb=96):
        ...
        Args:
            benchmark_name: Full benchmark name (e.g., "pts/compress-zstd-1.6.0")
...
class CompressZstdRunner:
    ...
    def run(self):
        """Main execution flow."""
        print(f"{'='*80}")
        print("Zstd Compression Benchmark Runner")
        print(f"{'='*80}")
...
def main():
    ...
    runner = CompressZstdRunner(threads_arg=threads, quick_mode=args.quick)
    success = runner.run()
