...
for required_script in setup_init.sh setup_gcc14.sh setup_binutil244.sh setup_jdkxx.sh build_zlib.sh setup_pcre.sh setup_selinux_ports.sh setup_pts.sh setup_rust.sh setup_srs.sh setup_llama.sh build_numpy_wheelhouse.sh; do
...
"$SCRIPT_DIR/build_numpy_wheelhouse.sh"
