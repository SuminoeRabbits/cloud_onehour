...
| `json_parser_pmbench-1.0.2.py` | C (JSON) | 複数 | `<N>-thread.json` から取得 |
| `json_parser_redis-1.3.1.py` | C (JSON) | 複数 | `<N>-thread.json` から取得 |
| `json_parser_redis-1.5.0.py` | C (JSON) | 複数 | `<N>-thread.json` から取得 |
| `json_parser_renaissance-1.4.0.py` | - | - | bench_results にデータなし (未実行) |
...
| `json_parser_spark-1.0.1.py` | C (JSON) | 複数 | `<N>-thread.json` から取得 |
