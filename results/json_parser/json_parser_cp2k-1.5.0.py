...
def _collect_thread_payload(
    ...
    test_payload: Dict[str, Any] = {
        "cp2k [Seconds]": {
            "description": "CP2K Quantum Chemistry",
            "values": value,
            "raw_values": [value],
            "unit": "Seconds",
            "time": value,
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(
        description=(
            "cp2k parser: cloud_onehour/results/<machinename> を入力に "
